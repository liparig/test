	...
	public class JRangeSliderPanel extends javax.swing.JPanel {
	    ...
	    public JRangeSliderPanel() {
	        ...
	        upperBoundTextField = new javax.swing.JTextField();
	        	        ...
	        	        upperBoundTextField.setEnabled(false);
	        	        GridBagConstraints gbc_upperBoundTextField = new GridBagConstraints();
	        	        gbc_upperBoundTextField.fill = GridBagConstraints.HORIZONTAL;
	        	        gbc_upperBoundTextField.gridx = 1;
	        	        gbc_upperBoundTextField.gridy = 1;
	        	        add(upperBoundTextField, gbc_upperBoundTextField);
	    ...
	    private void initComponents() {
	        ...
	        gridBagLayout.rowHeights = new int[]{23, 14, 0};
	        ...
	        setLayout(gridBagLayout);
	        	        ...
	        	        rangeSlider.setMinimum(50);
	        	        	        ...
	        	        	        gbc_rangeSlider.anchor = GridBagConstraints.NORTH;
	        	        	        gbc_rangeSlider.fill = GridBagConstraints.HORIZONTAL;
	        	        	        gbc_rangeSlider.insets = new Insets(0, 0, 5, 0);
	        	        	        gbc_rangeSlider.gridwidth = 2;
	        ...
	        lowerBoundTextField.setEnabled(false);
	        GridBagConstraints gbc_lowerBoundTextField = new GridBagConstraints();
	        gbc_lowerBoundTextField.fill = GridBagConstraints.HORIZONTAL;
	        gbc_lowerBoundTextField.insets = new Insets(0, 0, 0, 5);
	        gbc_lowerBoundTextField.gridx = 0;
	        gbc_lowerBoundTextField.gridy = 1;
	        add(lowerBoundTextField, gbc_lowerBoundTextField);
